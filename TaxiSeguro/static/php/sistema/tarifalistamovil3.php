...
<?php
    ...
    if($_SESSION['tiposocio']=="administrador") {
        $query="SELECT id, numerotaxi, nombresocio, password, edad, tiposocio FROM tabulador";
    }else if($_SESSION['tiposocio']=="socio") {
        $query="SELECT id, numerotaxi, nombresocio, password, edad, tiposocio FROM tabulador WHERE numerotaxi LIKE '$numerotaxi%'";
    }else{
        $query="SELECT id, numerotaxi, nombresocio, password, edad, tiposocio FROM tabulador WHERE numerotaxi LIKE '$numerotaxi%'";
    }
