...
<div class="table-responsive tabla11" id="tabledefinida">
    <table class="table table-hover tabla2">
        <thead>
        <?php while($tabulador=$resultado->fetch_assoc()){ ?>
        <tr class="encabezadotabla">
            <th>Lugar de Origen</th>
            <td><?php echo $tabulador['origen'];?></td>
        </tr>
        <tr class="encabezadotabla">
            <th>Lugar de Destino</th>
            <td><?php echo $tabulador['destino'];?></td>
        </tr>
        <tr class="encabezadotabla">
            <th>Costo</th>
            <td><?php echo $tabulador['costo'];?></td>
        </tr>
        <tr class="encabezadotabla">
            <?php
                if($_SESSION['tiposocio']=="administrador") {
            ...
            <?php
                if($_SESSION['tiposocio']=="administrador") {
                    echo'<td>';
                        echo'<a class="btn btn-warning btn-xs" href="tarifamodificar.php?id=';?><?php echo $tabulador['id'];?><?php echo'"  type="button" data-toggle="modal" data-target="#ModalVer"><span class="icon-pencil2"></span> Editar</a>';
                    echo'</td>';
                }else{
                }
            ?>
        ...
        <tr class="encabezadotabla">
            ...
            <?php
                if($_SESSION['tiposocio']=="administrador") {
                    echo'<td>';
                        echo'<a class="btn btn-danger btn-xs" href="tarifaeliminar.php?id=';?><?php echo $tabulador['id'];?><?php echo'"  type="button" data-toggle="modal" data-target="#ModalVer"><span class="icon-minus"></span> Eliminar</a>';
                    echo'</td>';
                }else{
                }
            ?>
